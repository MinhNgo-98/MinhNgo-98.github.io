<template>
  <Layout>
    ...
    <div class="newsletter bg-background-tertiary">
      <div class="container-inner mx-auto py-16 pb-8 text-center xlxtl-xl">
        <h2 class="text-xl font-bold mb-8">Join my Newsletter</h2>

        <div class="w-4/5 mx-auto mb-8">
          <p class="mb-8 text-xl sm:text-xl">
          ...
          <form action="#">
            <div class="flex flex-col sm:flex-row">
              <input
                ...
                class="flex-1 bg-background-form rounded sm:rounded-r-none px-4 py-4 leading-light border border-border-color-primary sm:border-r-0 shadow outline-none focus:border-blue-700 z-10"
                required
              />
              <button
                data-element="submit"
                class="flex-2 w-40 uppercase bg-blue-700 text-white rounded sm:rounded-l-none text-xl py-3 px-8 tracking-wide shadow focus:outline-none hover:bg-blue-800 focus:bg-blue-800 z-10 w-full sm:w-auto mt-4 sm:mt-0"
              >
                <span>Subscribe</span>
              </button>
            </div>
